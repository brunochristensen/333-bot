...
class AccountabilityCog(commands.Cog):
  ...
  async def my_task(self):
    ...
    await self.bot.send('Pick your favourite colour:', view=view)
...
class AccountabilityDropdown(discord.ui.Select):
  def __init__(self):
      ...
      super().__init__(placeholder='Choose your reason for absence:', min_values=1, max_values=1, options=options)
