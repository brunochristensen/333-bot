...
public class AccountabilityCommand extends ListenerAdapter {
    ...
    private final MessageEmbed controlMenu = new EmbedBuilder()
    ...
    public void onReady(@NotNull ReadyEvent event) {
        try {
            ...
            Objects.requireNonNull(event.getJDA().getTextChannelById(envGetter.get("DEBUG_CHANNEL_ID")))
    ...
    public void onButtonInteraction(@NotNull ButtonInteractionEvent event) {
        if (event.getComponentId().equals("accView")) {
            ...
            Hashtable<String, String> report = AccountabilityRecord.getInstance().getAccountabilityReport();
